...
function renderRank(id) {
  ...
  function rank() {
    ...
    var ranking = serverRank(pokeArray);
    var rank=0;
    var string = ""
...
*******************************************************************************/
  ...
  function serverTap(slat, slong, dlat, dlong) {
    var returnData = {
      uberPrice: 5.00,
      uberTime: 5.00
    };
  ...
  function tap(id) {
    ...
    var result = serverTap(position.lat, position.lng, pokemon.position.lat, pokemon.position.lng);
    ...
    uberTimeField.innerHTML = result.uberTime + ' min away';
...
-------------- INIT ------------------------------------------------------------
*******************************************************************************/
  position = {lat: 45.5043292,lng: -122.7170117};
